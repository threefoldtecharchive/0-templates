...
class Network(TemplateBase):
    ...
    def _monitor(self):
        ...
        if "backplane" in nics_status and nics_status["backplane"] is False:
            ...
            alert_data[
                "text"
            ] = "backplane is down. Storage network is now offline for this node. Need imediate intervention"
        ...
        if nr_nic_down < len(nics_status):
            ...
            alert_data[
                "text"
            ] = "All interfaces used for the storage network are down. Storage network is now offline for this node, needs imediate intervention"
